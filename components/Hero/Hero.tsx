  ...
  return (
    <section className="flex flex-col justify-between items-center gap-4 w-11/12 sm:flex-row sm:w-11/12 md:w-11/12 lg:w-5/6 mx-auto mb-[25vh] pt-28">
      <span className="flex flex-col items-start gap-4 w-1/2">
        <h4 className="font-poppins font-medium text-red text-sm tracking-tight leading-none sm:text-base md:text-lg lg:text-xl py-3 px-6 rounded-lg bg-white">
          Never Stop Learning
        </h4>
        ...
        <p className="text-justify text-lg font-medium">
          e-learn is a Global training provider based in Indonesia that
